...
#define HOMING_BACKOFF_POST_MM { 0, 30, 0 }  // (mm) Backoff from endstops after homing
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         200 //50  // (mm) Length to extrude after loading.
 ...
 */
  ...
  //#define SERVICE_NAME_1      "Сервис через "
