...
//
  ...
  #endif
  #ifndef Y_MAX_PIN
    #define Y_MAX_PIN                        58 // 15
  #endif
#endif
#ifndef Z_STOP_PIN
  #ifndef Z_MIN_PIN
    #define Z_MIN_PIN                        5 // 18
  #endif
  #ifndef Z_MAX_PIN
    //#define Z_MAX_PIN                         19
  #endif
...
//
  ...
  //  #define SPINDLE_LASER_ENA_PIN              57  // Pullup or pulldown!
...
#define STAT_LED_RED_PIN 	  47
#define STAT_LED_BLUE_PIN 	45
  ...
  //
      ...
      //#define BEEPER_PIN                      37
        ...
        #define BTN_EN2                       23
      #else
        #define BTN_EN1                       37 //31
        #define BTN_EN2                       35 //33
      #endif
