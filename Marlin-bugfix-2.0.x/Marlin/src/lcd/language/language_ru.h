...
namespace Language_ru {
  ...
  PROGMEM Language_Str MSG_MAGNUM                         = _UxGT("- Magnum 3D -");
  PROGMEM Language_Str WELCOME_MSG                         = _UxGT("== Готов к печати ==");
  //PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT("готов к печати ==");
  ...
  PROGMEM Language_Str MSG_ADVANCED_SETTINGS               = _UxGT("Расширенные");
  ...
  PROGMEM Language_Str MSG_AUTO_HOME                       = _UxGT("Парковка головки");
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_HOMING                = _UxGT("Парковка экструдера");
  ...
  PROGMEM Language_Str MSG_PREHEAT_CUSTOM                  = _UxGT("Или температура");
  ...
  PROGMEM Language_Str MSG_LEVEL_CORNERS                   = _UxGT("Калибровка стола");
  PROGMEM Language_Str MSG_NEXT_CORNER                     = _UxGT("Следующая точка");
  ...
  PROGMEM Language_Str MSG_NOZZLE                          = _UxGT("Экструдер");
  PROGMEM Language_Str MSG_NOZZLE_N                        = _UxGT("Экструдер ~");
  PROGMEM Language_Str MSG_BED                             = _UxGT("Стол");
  PROGMEM Language_Str MSG_FAN_SPEED                       = _UxGT("Обдув модели");
  ...
  PROGMEM Language_Str MSG_JERK                            = _UxGT("Плавность хода");
  ...
  PROGMEM Language_Str MSG_VELOCITY                        = _UxGT("Скоростной режим");
  ...
  PROGMEM Language_Str MSG_ACCELERATION                    = _UxGT("Ускорения");
  ...
  PROGMEM Language_Str MSG_TEMPERATURE                     = _UxGT("Нагрев и обдув");
  PROGMEM Language_Str MSG_MOTION                          = _UxGT("Движение по осям");
  ...
  PROGMEM Language_Str MSG_STORE_EEPROM                    = _UxGT("Запись настроек");
  PROGMEM Language_Str MSG_LOAD_EEPROM                     = _UxGT("Чтение настроек");
  PROGMEM Language_Str MSG_RESTORE_DEFAULTS                = _UxGT("Сброс настроек");
  PROGMEM Language_Str MSG_INIT_EEPROM                     = _UxGT("Сброс EEPROM");
  PROGMEM Language_Str MSG_SETTINGS_STORED                 = _UxGT("Настройки обновлены");
  PROGMEM Language_Str MSG_MEDIA_UPDATE                    = _UxGT("Перепрошивка");
  PROGMEM Language_Str MSG_RESET_PRINTER                   = _UxGT("Перегрузите принтер");
  ...
  PROGMEM Language_Str MSG_TUNE                            = _UxGT("Подстройка печати");
  ...
  PROGMEM Language_Str MSG_BUTTON_DONE                     = _UxGT("Завершить");
  ...
  PROGMEM Language_Str MSG_KILLED                          = _UxGT("ОСТАНОВЛЕН. ");
  ...
  PROGMEM Language_Str MSG_FILAMENTCHANGE                  = _UxGT("Заменить пруток");
  PROGMEM Language_Str MSG_FILAMENTCHANGE_E                = _UxGT("Заменить пруток *");
  PROGMEM Language_Str MSG_FILAMENTLOAD                    = _UxGT("Загрузка прутка");
  PROGMEM Language_Str MSG_FILAMENTLOAD_E                  = _UxGT("Загрузка прутка *");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD_E                = _UxGT("Выгрузка прутка *");
  ...
  PROGMEM Language_Str MSG_ERR_REDUNDANT_TEMP              = _UxGT("ERR: Избыточная Т");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY                 = _UxGT("ERR: TermRun");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_BED             = _UxGT("ERR: TermRun-Bed");
  // TODO: Heated chamber
  ...
  PROGMEM Language_Str MSG_INFO_STATS_MENU                 = _UxGT("Статистика печати");
  ...
  PROGMEM Language_Str MSG_KILL_EXPECTED_PRINTER           = _UxGT("Неверный принтер");
    ...
    PROGMEM Language_Str MSG_INFO_COMPLETED_PRINTS         = _UxGT("Статистика");
    PROGMEM Language_Str MSG_INFO_PRINT_TIME               = _UxGT("Общее время печати");
    PROGMEM Language_Str MSG_INFO_PRINT_LONGEST            = _UxGT("Самая долгая печать");
    PROGMEM Language_Str MSG_INFO_PRINT_FILAMENT           = _UxGT("Потрачено пластика");
  #else
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER_PAUSE    = _UxGT("ЗАМЕНА ПРУТКА");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_NOZZLE          = _UxGT("Экструдер: ");
  ...
  //PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Обрежьте пруток", "и нажмите кнопку", "для загрузки"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Замените пруток", "Нажмите для загрузки", "---"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_CONT_PURGE    = _UxGT(MSG_2_LINE("Нажмите кнопку для", "завершения загрузки"));
  ...
  PROGMEM Language_Str MSG_TMC_DRIVERS                     = _UxGT("Двигатели");
  PROGMEM Language_Str MSG_TMC_CURRENT                     = _UxGT("Токи двигателей");
